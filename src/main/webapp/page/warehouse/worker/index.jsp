...
<%    String __strPageCode = "P0000000003";
    request.setAttribute("sublink", "../../../");
    request.setAttribute("title", "พนักงานคลัง ขาย");
//    request.setAttribute("css", Arrays.asList("css/sweetalert.css", "css/bootstrap-datetimepicker.min.css"));
    request.setAttribute("js", Arrays.asList(
            ...
            "../../../public/pickandpack/js/warehouse/worker/script.js"));
            ...
            <div class="main_container">
                ...
                <div class="right_col" role="main">
                    <div class="">
                                            ...
                                            <div class="col-md-3 col-sm-3 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="sel-status-type">
                                                        ...
                                                        <option value="1">รอจัด</option>
                                                        <option value="2">กำลังจัด</option>
                                                        <option value="3">จัดเสร็จ</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="x_panel">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-condensed table-striped text-center" style="margin: 0; padding: 0; color: #000;">
                                            ...
                                            <th class="text-center" colspan="4" style="width: 5%"><i class="fa fa-cog"></i></th>
                                            </thead>
                        ...
                        <div id="content-mod-reason-box" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static">
                            <div class="modal-dialog">

                                <!-- Modal content-->
                                <form id="frm-mod-reason">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                <label for="sel_mod_reason">เหตุผลการไม่อนุมัติ</label>
                                                <select id="sel_mod_reason" name="sel_mod_reason" class="form-control"></select>
                                            </div>

                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-danger" data-dismiss="modal">ยกเลิก</button>
                                            <button type="submit" id="mod-btn-submit" class="btn btn-primary">ตกลง</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
