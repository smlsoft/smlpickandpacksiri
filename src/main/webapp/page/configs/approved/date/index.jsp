...
<%    
    String __strPageCode = "P0000000008";
    request.setAttribute("sublink", "../../../../");
    request.setAttribute("title", "กำหนดวันที่เอกสารเริ่มต้นที่จะดึง");
//    request.setAttribute("css", Arrays.asList("css/sweetalert.css", "css/bootstrap-datetimepicker.min.css"));
    request.setAttribute("js", Arrays.asList(
            ...
            "../../../../public/pickandpack/js/configs/approved/date/script.js"));
            ...
            <div class="main_container">
                ...
                <div class="right_col" role="main">
                    <div class="">
                                            ...
                                            <div class="col-md-3 col-sm-3 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" id="txt-search" class="form-control"  placeholder="ใส่ข้อมูลค้นหา" readonly="true">
                                                        <span class="input-group-btn">
                                                            <button type="button" id="btn-search" class="btn btn-primary btn-flat" disabled="true"><i class="fa fa-search"></i></button>
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <!--Content Form-->
                        <div class="row" id="content-form-box" style="display: none;">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>ฟอร์ม กำหนดวันที่เอกสารเริ่มต้นที่จะดึง</h2>
                                        <div class="clearfix"></div>
                                    </div>
                                    <div class="x_content">
                                        <form id="frm-begin-date">
                                            <div class="row">
                                                <div class="col-md-3 col-sm-3 col-xs-6">
                                                    <div class="form-group">
                                                        <label for="txt_begin_date" class="control-label">ถึงวันที่</label>
                                                        <div class="input-group">
                                                            <div class="input-group-addon">
                                                                <i class="fa fa-calendar text-primary"></i>
                                                            </div>
                                                            <input type="text" id="txt_begin_date" name="txt_begin_date" class="form-control">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                    <div class="form-group text-right">
                                                        <button type="button" id="btn-cancel" class="btn btn-danger btn-flat">กลับ</button>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-condensed table-striped text-center" style="margin: 0; padding: 0; color: #000;">
                                            ...
                                            <tbody id="content-table-list">
                                                <tr><td colspan='3'><p class='text-center'><span class='fa fa-spinner fa-spin fa-2x fa-fw'></span> กำลังโหลดข้อมูล...</p></td></tr>
                                            </tbody>
                                        </table>
                                    </div>
                                </div>
