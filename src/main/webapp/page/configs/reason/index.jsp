...
<%    String __strPageCode = "P0000000007";
    request.setAttribute("sublink", "../../../");
    request.setAttribute("title", "กำหนดเหตุผล");
//    request.setAttribute("css", Arrays.asList("css/sweetalert.css", "css/bootstrap-datetimepicker.min.css"));
    request.setAttribute("js", Arrays.asList(
            ...
            "../../../public/pickandpack/js/configs/reason/script.js"));
                    ...
                    <div class="">
                        ...
                        <div class="row" id="content-form-box" style="display: none;">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>ฟอร์ม กำหนดหมายเลขเครื่อง</h2>
                                        <div class="clearfix"></div>
                                    </div>
                                    <div class="x_content">
                                        <form id="frm-reason">
                                            <div class="row">
                                                <div class="col-md-3 col-sm-4 col-xs-12">
                                                    <div class="form-group">
                                                        <label for="txt_reason_code" class="control-label">รหัสเหตุผล</label>
                                                        <input type="text" id="txt_reason_code" name="txt_reason_code" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-md-3 col-sm-4 col-xs-12">
                                                    <div class="form-group">
                                                        <label for="txt_reason_name" class="control-label">ชื่อเหตุผล</label>
                                                        <input type="text" id="txt_reason_name" name="txt_reason_name" class="form-control">
                                                    </div>  
                                                </div>
                                            </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-condensed table-striped text-center" style="margin: 0; padding: 0;">
                                            <thead>
                                            <th class="text-center">รหัสเหตุผล</th>
                                            <th class="text-center">ชื่อเหตุผล</th>
