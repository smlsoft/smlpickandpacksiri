...
<%    
    String __strPageCode = "P0000000005";
    request.setAttribute("sublink", "../../../../");
    request.setAttribute("title", "กลุ่ม คลังสินค้าและสถานที่เก็บสินค้า");
//    request.setAttribute("css", Arrays.asList("css/sweetalert.css", "css/bootstrap-datetimepicker.min.css"));
    request.setAttribute("js", Arrays.asList(
            ...
            "../../../../public/pickandpack/js/configs/groups/locations/script.js"));
                    ...
                    <div class="">
                        <div class="page-title">
                            <div class="title">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <h3>${title} <small>กำหนดหมายเลขเครื่องเข้ากลุ่มคลังสินค้าและที่เก็บสินค้า</small></h3>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row" id="content-form-box" style="display: none;">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>ฟอร์ม กำหนดคลังสินค้าและสถานที่เก็บสินค้า</h2>
                                        <div class="clearfix"></div>
                                    </div>
                                    <div class="x_content">
                                        <!--<form id="frm-group-location">-->
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                    <div class="form-group text-right">
                                                        ...
                                                        <button type="button" id="btn-submit" class="btn btn-success btn-flat">บันทึก</button>
                                                    </div>
                                                </div>
                                            </div>
                                        <!--</form>-->
                                ...
                                <div class="x_panel">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-condensed table-striped text-center" style="margin: 0; padding: 0; color: #000;">
                                            <thead>
                                            <th class="text-center">รหัสกลุ่ม ~ ชื่อกลุ่ม</th>
                                            <th class="text-center">รหัสคลัง</th>
                                            <!--<th class="text-center">รหัสสถานที่เก็บ</th>-->
                                            <th class="text-center" colspan="3" style="width: 5%"><i class="fa fa-cog"></i></th>
                                            </thead>
                                            <tbody id="content-table-list">
                                                <tr><td colspan='5'><p class='text-center'><span class='fa fa-spinner fa-spin fa-2x fa-fw'></span> กำลังโหลดข้อมูล...</p></td></tr>
                                            </tbody>
                                        </table>
                                    </div>
                                </div>
