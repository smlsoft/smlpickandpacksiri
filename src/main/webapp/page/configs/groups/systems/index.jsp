...
<%    String __strPageCode = "P0000000006";
    request.setAttribute("sublink", "../../../../");
    request.setAttribute("title", "กำหนดหมายเลขเครื่อง");
//    request.setAttribute("css", Arrays.asList("css/sweetalert.css", "css/bootstrap-datetimepicker.min.css"));
    request.setAttribute("js", Arrays.asList(
            ...
            "../../../../public/pickandpack/js/configs/groups/systems/script.js"));
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 col-sm-3 col-xs-12">
                                                <div class="form-group">
                                                    <label class="control-label">ค้นหาหมายเลขเครื่อง</label>
                                            ...
                                            <div class="col-md-3 col-sm-3 col-xs-12">
                                                <label class="control-label">หมายเลขเครื่องนี้</label>
                                                <input type="text" class="form-control"  placeholder="ใส่ข้อมูลค้นหา" value="${system_id}" readonly="true">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 col-sm-4 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="txt_system_id" name="txt_system_id" class="form-control">
                                                    </div>  
                                                </div>
                                            </div>
