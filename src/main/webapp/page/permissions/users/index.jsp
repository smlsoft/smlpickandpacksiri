...
<%    String __strPageCode = "P0000000009";
    request.setAttribute("sublink", "../../../");
    request.setAttribute("title", "กำหนดสิทธิ์ ตามผู้ใช้งาน");
//    request.setAttribute("css", Arrays.asList("css/sweetalert.css", "css/bootstrap-datetimepicker.min.css"));
    request.setAttribute("js", Arrays.asList(
            ...
            "../../../public/pickandpack/js/permissions/users/script.js"));
                    ...
                    <div class="">
                        ...
                        <div class="row" id="content-form-box" style="display: none;">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>ฟอร์ม กำหนดสิทธิ์ตามผู้ใช้งาน</h2>
                                        <div class="clearfix"></div>
                                    </div>
                                    <div class="x_content">
                                        <div class="table-responsive">
                                            <table class="table table-condensed table-striped text-center" style="margin: 0; padding: 0; color: #000;">
                                                ...
                                                <tbody id="content-pagelist-list"></tbody>
                                            </table>
                                        </div>
