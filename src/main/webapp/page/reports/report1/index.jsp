...
<%    String __strPageCode = "P0000000012";
    request.setAttribute("sublink", "../../../");
    request.setAttribute("title", "รายงาน วิเคราะห์การจ่ายสินค้าขาด");
//    request.setAttribute("css", Arrays.asList("css/sweetalert.css", "css/bootstrap-datetimepicker.min.css"));
    request.setAttribute("js", Arrays.asList(
            ...
            "../../../public/pickandpack/js/reports/report1/script.js"));
                                ...
                                <div class="x_panel" style="padding: 0">
                                    <div class="table-responsive">
                                        <table class="table table-condensed table-striped table-bordered text-center" style="margin: 0; padding: 0; color: #000;">
                                            <thead>
                                            <th class="text-center">พื้นที่เก็บสินค้า</th>
                                            <th class="text-center">วันที่</th>
                                            <th class="text-center">วันที่ใบจัด</th>
                                            <th class="text-center">เลขที่ใบจัด</th>
                                            <th class="text-center">รหัสสินค้า</th>
                                            <th class="text-center">ชื่อสินค้า</th>
                                            <th class="text-center">ยอดสั่งจัด</th>
                                            <th class="text-center">จำนวนที่จัดได้</th>
                                            <th class="text-center">จำนวนที่ขาด</th>
                                            <th class="text-center">สาเหตุที่จัดขาด</th>
                                            </thead>
